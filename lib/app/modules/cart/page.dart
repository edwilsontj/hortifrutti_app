          ...
          () => Column(
            children: [
              ...
              for (var cartProduct in controller.products)
                // var totGeral += cartProduct.total.value,
                ListTile(
                  title: Text(cartProduct.product.name),
                  subtitle: Text(
                      'Total do item ${NumberFormat.simpleCurrency().format(cartProduct.total)} ( ${NumberFormat.simpleCurrency().format(cartProduct.product.price)} )',
